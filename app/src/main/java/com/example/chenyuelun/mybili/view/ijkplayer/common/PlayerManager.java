package com.example.chenyuelun.mybili.view.ijkplayer.common;
...
import com.example.chenyuelun.mybili.view.ijkplayer.media.IRenderView;
import com.example.chenyuelun.mybili.view.ijkplayer.media.IjkVideoView;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity) {
        ...
        videoView = (IjkVideoView) activity.findViewById(R.id.videoview);
